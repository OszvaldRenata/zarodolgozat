...
<?php
	...
	if (isset($_SESSION['bejelentkezve'])) {
		...
		if (isset($_SESSION['id'])) {
			$sajatfelhnev = $_SESSION['id'];
		}

		$active = 'sajathirdetes';
		include('navbar.php'); ?>
		...
		<div class="tartalom container">	
			<div class="container min-vh-100">
				...
				<div>
					<h5>Itt tudod kezelni a hirdetéseidet.</h5>
				</div>
	    ...
	    if (isset($_POST['submitdelete'])) {
	    	...
	    	$sor_torles = "DELETE FROM hirdetesek WHERE id = '$key' ";
	   	...
	   	$kulcs = $_POST['azonosito'];

	   	$sor_update = "UPDATE hirdetesek SET cime = '".$_POST['cim']."', tartalom = '".$_POST['tartalma']."', termek_ara =  '".$_POST['termekar']."' WHERE id = '$kulcs' ";
	   	...
	   	if ($conn->query($sor_update) == true) {
			...
			$kivalasztas = "SELECT * FROM hirdetesek WHERE felhasznalo_id = '$sajatfelhnev'";
		        	...
		        	<div class="container sajathirdetesek text-center border border-dark">
						...
						<div class="row py-2">
							<div class="col-12 col-sm-12 col-md-12 col-lg-2">
								...
								<form method="post">
									...
									<p>Tevékenység</p>
									<input type="hidden" name="azonosito" value="<?php echo $sor['id'];?>">
									<button onclick="return confirm('Biztosan törölni szeretnéd?')" class="mb-2" type="submit" name="submitdelete">Törlés</button>
									
								</form>

									<button id="<?php echo 'show'.$sor['id'];?>" name="szerkeszt" type="button">Szerkesztés</button>
							</div>

				  			<div class="col-12 col-sm-12 col-md-6 col-lg-3">
				  				<p><img onclick="image(this)" style="height: 150px; width: 150px" src="<?php echo 'images/' . $sor['image']; ?>"></p>
				  			</div>
							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-2">
								...
								<p><u>Ár</u></p>
								<p><?php echo number_format($sor['termek_ara'])?>Ft</p>
							</div>

							<div class="hszoveg col-12 col-sm-12 col-md-6 col-lg-3">
								<p><u>Leírás</u></p>
		          		...
		          		<form method="post">
		          				...
		          				<input type="hidden" name="azonosito" value="<?php echo $sor['id'];?>">
								<textarea required minlength="10" maxlength="50" class="col-10" name="cim" cols="30" rows="3" id="<?php echo 'text'.$sor['id'];?>" style="display: none;"><?php echo $sor['cime'];?></textarea>
								<textarea required minlength="50" maxlength="250" class="col-10" name="tartalma" cols="30" rows="3" id="<?php echo 'texti'.$sor['id'];?>" style="display: none;"><?php echo $sor['tartalom'];?></textarea>
								<textarea required class="col-4" name="termekar" cols="6" rows="1" id="<?php echo 'textarea'.$sor['id'];?>" style="display: none;"><?php echo $sor['termek_ara'];?></textarea><br>
								<button name="frissites" value="<?php echo $sor['id'];?>" id="<?php echo 'gomb'.$sor['id'];?>" style="display: none;" type="submit">Frissít</button>
				 	...
				 	<script type="text/javascript">
						...
						$(document).ready(function(){
							var textarea = $('#<?php echo 'text'.$sor['id'];?>');
							var textarea1 = $('#<?php echo 'texti'.$sor['id'];?>');
							var textarea2 = $('#<?php echo 'textarea'.$sor['id'];?>');
							var button = $('#<?php echo 'gomb'.$sor['id'];?>');
